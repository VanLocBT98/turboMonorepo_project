  ...
  return (
    <SvgIcon {...props} className="linear">
      ...
      <path
        stroke={linearColor}
        strokeWidth="1.5"
        d="M15 19.083C15 20.694 13.657 22 12 22s-3-1.306-3-2.917c0-.912.961-2.1 1.796-2.959a1.665 1.665 0 012.408 0c.835.86 1.796 2.047 1.796 2.96z"
      />
    </SvgIcon>
  );
}
