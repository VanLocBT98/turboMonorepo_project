  ...
  return (
    <SvgIcon {...props} className="linear">
      <path
        stroke={linearColor}
        strokeWidth="1.5"
        d="M2 15a5 5 0 015-5h10a5 5 0 010 10H7a5 5 0 01-5-5z"
      />
      <path
        fill={linearColor}
      ...
      <path
        stroke={linearColor}
        strokeWidth="1.5"
        d="M8.5 15a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z"
      />
      <path
        stroke={linearColor}
        strokeLinecap="round"
...
export default WifiRouterRoundIcon;
