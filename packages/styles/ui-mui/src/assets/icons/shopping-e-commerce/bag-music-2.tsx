...
function BagMusic2Icon({ linearColor = "#1C274C", ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className="linear">
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M9 6V5a3 3 0 116 0v1M13 16v-6"
      />
      <circle cx="11" cy="16" r="2" stroke={linearColor} strokeWidth="1.5" />
      <path
        stroke={linearColor}
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M15 12a2 2 0 01-2-2"
      />
    </SvgIcon>
  );
}
