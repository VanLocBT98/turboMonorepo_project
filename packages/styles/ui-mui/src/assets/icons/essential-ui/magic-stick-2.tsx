...
function MagicStick2Icon({
  ...
  return (
    <SvgIcon {...props} className="linear">
      ...
      <path
        fill={linearColor}
        d="M17.53 16.47a.75.75 0 10-1.06 1.06l1.06-1.06zm2.94 5.06a.75.75 0 101.06-1.06l-1.06 1.06zm-4-4l4 4 1.06-1.06-4-4-1.06 1.06z"
      />
    </SvgIcon>
  );
}

export default MagicStick2Icon;
