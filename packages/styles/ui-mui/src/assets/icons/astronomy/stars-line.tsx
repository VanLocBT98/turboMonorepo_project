...
function StarsLineIcon({ linearColor = "#1C274C", ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className="linear">
      ...
      <path
        ...
        d="M5 13.268s.65.748 1.223.901c.573.154 1.51-.169 1.51-.169s-.749.65-.902 1.223c-.154.573.169 1.51.169 1.51s-.65-.749-1.223-.902c-.573-.154-1.51.17-1.51.17s.749-.65.902-1.224C5.323 14.206 5 13.268 5 13.268z"
      />
    </SvgIcon>
  );
}
