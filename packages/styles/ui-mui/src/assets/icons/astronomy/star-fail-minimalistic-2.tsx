...
function StarFailMinimalistic2Icon({
  linearColor = "#1C274C",
  ...props
}: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className="linear">
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth="1.5"
        d="M2.089 16a4.736 4.736 0 014-.874M2.089 10.5c1-.5 1.29-.44 2-.5M2 5.609l.208-.122c2.206-1.292 4.542-1.64 6.745-1.005l.208.06"
      />
    </SvgIcon>
  );
}
