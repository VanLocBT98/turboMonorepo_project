...
function BluetoothWaveIcon({
  ...
  return (
    <SvgIcon {...props} className="linear">
      ...
      <path
        fill={linearColor}
        d="M2.57 14.886a.75.75 0 10.86 1.228l-.86-1.228zm.86 1.228l5-3.5-.86-1.228-5 3.5.86 1.228z"
      />
      <path
        fill={linearColor}
        d="M2.57 9.114a.75.75 0 01.86-1.228l-.86 1.228zm.86-1.228l5 3.5-.86 1.228-5-3.5.86-1.228z"
      />
      <path
        stroke={linearColor}
        strokeLinecap="round"
