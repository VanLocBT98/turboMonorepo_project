  ...
  return (
    <SvgIcon {...props} className="linear">
      <g clipPath="url(#clip0_9754_6666)">
        ...
        <path
          fill={linearColor}
          d="M16 10.5a1 1 0 11-2 0 1 1 0 012 0zM18 13.5a1 1 0 11-2 0 1 1 0 012 0z"
        />
        <path
          stroke={linearColor}
          strokeLinecap="round"
          strokeWidth="1.5"
          d="M12 4V3a1 1 0 011-1h1a1 1 0 001-1V0"
        />
        <path
          stroke={linearColor}
          strokeWidth="1.5"
