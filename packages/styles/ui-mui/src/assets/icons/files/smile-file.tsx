...
function SmileFileIcon({ linearColor = "#1C274C", ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} className="linear">
      ...
      />
      <ellipse cx="17" cy="14.5" fill={linearColor} rx="1" ry="1.5" />
      <path
        stroke={linearColor}
        strokeLinecap="round"
      ...
      />
      <ellipse cx="7" cy="14.5" fill={linearColor} rx="1" ry="1.5" />
    </SvgIcon>
  );
}
