...
function SocialMessengerColIcon({ ...props }: SvgIconOwnProps) {
  return (
    <SvgIcon {...props} viewBox="0 0 24 24">
      <path
        ...
        fill="url(#paint0_radial_9757_41016)"
      />
      <defs>
        <radialGradient
          id="paint0_radial_9757_41016"
          cx={0}
          cy={0}
          r={1}
          gradientUnits="userSpaceOnUse"
          gradientTransform="translate(7.07959 19.9144) rotate(-57.0915) scale(17.4335)"
        >
...
export default SocialMessengerColIcon;
