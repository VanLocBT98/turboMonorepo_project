...
export const SecExpWrap = styled(
  "div",
  {},
)(({ theme }) => ({
  position: "relative",
}));
export const SecExpWrapLottie = styled(
  "div",
  {},
)(({ theme }) => ({
  position: "absolute",
...
export const SecExpItem = styled(
  "div",
  {},
)(({ theme }) => ({ padding: "16px" }));
...
export const SecExpDate = styled(
  "span",
  {},
)(({ theme }) => ({ fontSize: "16px", color: theme.palette.grey?.["900"] }));

export const SecExpOther = styled(
  "div",
  {},
)(({ theme }) => ({ marginBottom: "8px" }));

export const SecExpOtherTitle = styled(
  "span",
  {},
)(({ theme }) => ({ fontWeight: 700, fontSize: "16px" }));
